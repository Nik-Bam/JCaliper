...
public class EntitySet extends TreeSet<Integer> implements Comparable<EntitySet> {
     ...
     *
     * @param collection a collection of entity IDs
     */
     ...
     *
     * @param set an array of entity IDs
     */
    ...
    /**
     * @param pool reference collection to get entity details from
     *
