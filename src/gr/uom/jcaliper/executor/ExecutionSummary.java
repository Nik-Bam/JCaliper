...
public class ExecutionSummary implements IDescribable {
    ...
    /**
     * @param craCase the craCase to set
     */
    ...
    /**
     * @param heuristicName the heuristicName to set
     */
    ...
    /**
     * @param heuristicShortName the heuristicShortName to set
     */
    ...
    /**
     * @param statesEvaluated the statesEvaluated to set
     */
    ...
    /**
     * @param refactored the refactored to set
     */
